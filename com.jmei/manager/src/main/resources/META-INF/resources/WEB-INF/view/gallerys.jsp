		...
		<div style="width:99%;min-height:100%;display:block;overflow:hidden;margin:0 auto;">
			...
			<div style="width:21%;float:left;min-height:82%;">
				<div class="sideMenu">
					...
					<ul>
						<li data-para="{'url':'${ctpath}/spring/cms/case/category/list','index':0}">淘宝首页焦点图</li>
						<li data-para="{'url':'${ctpath}/spring/cms/case/category/list','index':0}">腾讯娱乐频道焦点图</li>
						<li data-para="{'url':'${ctpath}/spring/cms/case/category/list','index':0}">腾讯电影频道焦点图</li>
						<li data-para="{'url':'${ctpath}/spring/cms/case/category/list','index':0}">网易游戏频道焦点图</li>
						<li data-para="{'url':'${ctpath}/spring/cms/case/category/list','index':0}">易迅首页焦点图</li>
					</ul>
					<h3><em></em>带按钮切换</h3>
					<ul>
						<li data-para="{'url':'${ctpath}/spring/cms/case/category/list',index:0}">淘宝首页今日活动</li>
